...
const REVIEWS = [
  ...
  { name: "João F.",      rating: 5,   text: "Sem perfeição, só consistência. Funcionou de verdade." },
];
    ...
    <div className="page">
      ...
      <section className="section hero" id="cta-top" data-reveal>
        <div className="container hero__wrap">
          <div className="hero__copy">
            ...
            <p className="subtitle">Sem dietas restritivas nem treinos exaustivos  só um método que entende o que te trava.</p>
      ...
      <section id="beneficios" className="section" data-reveal>
        <div className="container flow">
          <p className="lead">
            Diferente das promessas vazias, a abordagem atua por dentro e por fora, com clareza mental, disciplina emocional
            e passos diários simples que cabem na rotina.
          </p>
        </div>
      </section>
